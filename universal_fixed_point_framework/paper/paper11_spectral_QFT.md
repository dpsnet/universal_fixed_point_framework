...
| PMNS $\theta_{13}$ 的谱起源与定量预测 | ❌ | **§8.6 已撤回**：原 $\sin\theta_{13}\approx 0.011$ 与实验值 0.150 冲突；正确值见 Paper XVII $d_H/18 = 0.1505$ |
