...
| 版本 | 日期 | 更新内容 |
|---|---|---|
| v2.21 | 2026-07-17 | Phase 36-37 半涌现量去外部输入化同步：配套论文 I 引用更新至 v2.34（含 §A.15.7 谱间隙、§A.15.8 IFS 重叠因子）；L4 质量区间更新——ρ=0 由 Cl(1,7) 第一性原理确定，不再为自由参数，m_L4=1470 GeV 为唯一预测值；版本号升至 v2.21 |
