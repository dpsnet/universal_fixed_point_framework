...
> **版本对齐**：本总序对应全套论文最新基线——勘误与立场声明 [RAP_勘误与立场声明.md](RAP_勘误与立场声明.md) **v0.24**（2026-08-08，哈希 `2f4c155deb`），盲登记协议 [RAP_盲登记协议.md](RAP_盲登记协议.md) **v0.24**（1:1 同步）。全套共 42 篇论文（Papers I–XLII），全部 ✅ 稳定；主框架论文（Paper I）当前版本 **v2.52**。凡与早期版本冲突的表述，一律以本基线为准。
...
**以下修正集中在此，无需翻阅零散勘误文档。** 全部以 v0.24 基线为准：
...
## 附录 A：全套论文清单（Papers I–XLII，对应 v0.24 基线）
...
*本总序对应最新版本基线 v0.24（2026-08-08，哈希 `2f4c155deb`）。后续任何勘误更新将同步修订本总序并保留版本记录。*
