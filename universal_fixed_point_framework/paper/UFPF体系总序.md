...
> **版本对齐**：本总序对应全套论文最新基线——勘误与立场声明 [RAP_勘误与立场声明.md](RAP_勘误与立场声明.md) **v0.37**（2026-08-13，Paper XLIV 正文静态化 + P5 更名"场表述"：§7.3/§7.2 及正文清理日期与演进痕迹；P5"无粒子假设"→"场表述"（标准康普顿推导为场能量-动量守恒运动学），表述勘误、预言数值不变），盲登记协议 [RAP_盲登记协议.md](RAP_盲登记协议.md) **v0.37**（1:1 同步）。全套共 44 篇论文（Papers I–XLIV），全部 ✅ 稳定；主框架论文（Paper I）当前版本 **v2.52**。凡与早期版本冲突的表述，一律以本基线为准。
