...
| XLIV | [paper44_photon_topology.md](paper44_photon_topology.md) | 光子生成的拓扑分岔机制与可证伪预言（Phase 62 理论论文；拓扑分岔 + 方向性阶跃 + 双层正交 + 可拦截性 + 六项远期可证伪预言，数值自洽 36/36） |

配套文档：[RAP 勘误与立场声明 v0.31](RAP_勘误与立场声明.md)、[RAP 盲登记协议 v0.31](RAP_盲登记协议.md)。
