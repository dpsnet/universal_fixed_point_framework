...
**版本**：v0.3 草稿（2026-08-08，未纳入 RAP 登记）
...
4. **框架独有预测**（§4.2）：五项传统理论所无的定量预言（双曲标度、超压临界指数 ν≈1/2、突破通道 D_b=ln2/ln3、零注入阈值、单井窗口符号反转），其中 P1/P5 已获本数据集实证，P2 获形态支持，P3/P4 待针对性数据检验。
...
- 本稿为 v0.3 草稿：验证通过后按流程纳入 RAP 论文状态表并提炼正式版本。
