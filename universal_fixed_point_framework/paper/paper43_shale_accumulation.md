...
**版本**：v0.7 草稿（2026-08-08，未纳入 RAP 登记）
...
*实证数据*：Tuscaloosa 31 样品双曲拟合 $\ln P_t=-1.66/(D-2)+10.47$（R²=0.578）优于线性（R²=0.450）；理论斜率在 $D=2.86$ 处预测 2.24，与经验斜率 1.81 同量级吻合。
...
- 本稿为 v0.7 草稿：验证通过后按流程纳入 RAP 论文状态表并提炼正式版本。
