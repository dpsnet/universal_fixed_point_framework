# UFPF 勘误与立场声明（RAP-Errata v0.22）

**发布日期**：2026-08-07（v0.21）→ 2026-08-08（v0.22）
**版本哈希**：`8c7a06048f41968a00be8d0042297568cacb12a4`（v0.1）→ `5d4bdc215ef422d68961f6605a437dbbefa16426`（v0.2）→ `772d2ef75b`（v0.3）→ `57f3a7e4`（v0.4）→ `eff7bfb2`（v0.5）→ `e2cedd64`（v0.6）→ `7debbf68`（v0.7）→ `8587511c`（v0.8）→ `706ef820`（v0.9）→ **v0.10–v0.21（与盲登记 1:1 同步，见版本记录）** → `aa3603e3d9`（v0.22）
