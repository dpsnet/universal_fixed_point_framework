...
- 宇宙学谱动力学（FLRW 谱方程 + 慢滚暴胀兼容 + 暗能量谱解释）
...
| v0.7 | 2026-07-16 | 新增 §4.6（类 GR 场方程自然涌现：谱交织求导 → 谱曲率-物质流正比关系）；笔记 §9（从谱动力学倒退类广义相对论）；更新版本块 |
| v0.8 | 2026-07-16 | 宇宙学扩展：笔记 §10（FLRW谱方程 + 原初扰动 + 暗能量）；`paper5_cosmology.py`（n_s=0.9650, 0.0σ 与 Planck一致）；β 费米子系数修正自动解决（SU(2)/SU(3): 1.000000）；Phase 21 19/19 全部完成；数值脚本 7→8 |
