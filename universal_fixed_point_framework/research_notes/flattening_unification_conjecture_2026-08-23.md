...
> **命名说明**：本文档所述平展统一猜想（猜想 3.1-3.2）、推论 3.4（自洽理论覆盖）、猜想 3.5（最优理论 $T^*$）均属于**广义 UFPF**（G-UFPF）猜想体系。狭义 UFPF（UFPF₀）是有界算子 + H1-H5 假设下的四体制基础框架。猜想 3.5（最优理论 $T^*$ 存在）属于广义 UFPF 内部**额外更强的独立猜想**，广义 UFPF 的核心覆盖能力不依赖猜想 3.5 成立。
