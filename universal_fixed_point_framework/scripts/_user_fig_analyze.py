...
cols = np.where(col_sum > H * 0.4)[0]
rows = np.where(row_sum > W * 0.4)[0]
...
print("red px:", red.sum(), "green px:", green.sum(), "blue px:", blue.sum())
print("RED:")
for p in clusters(red):
    print("  ", p)
print("GREEN:")
for p in clusters(green):
    print("  ", p)
print("BLUE:")
for p in clusters(blue):
    print("  ", p)
