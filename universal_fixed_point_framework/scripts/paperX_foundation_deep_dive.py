...
def run():
    ...
    # ============================================================
    print("\n" + "=" * 76)
    print("D5. k_max=8 模型选择循环性（paper36 自认）")
    print("=" * 76)
    print(f"  paper36 文档：'最大模数 k_max：模型选择（数值扫描 {{4,6,8,16,100}} 中与 ρ_c 最佳匹配）'")
    ...
    check("D5 k_max=8 为拟合选择（匹配 ρ_c），非第一性导出；Δλ_min 公式在给定 k_max 下才严格",
          True, "Lean 形式化证明公式，未证明 k_max=8 的选择")
    ...
    print("    D5 k_max=8 为拟合选择（匹配 ρ_c），Δλ_min '第一性'仅限给定 k_max")
