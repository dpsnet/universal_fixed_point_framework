...
print(f"  逆方向: m = 8（旋量表示 8_s 独立确定 Cl(1,7)）⇒ n = m/2 = 4 唯一 ✅")  # 【2026-08-07 勘误：旧遗留记号 "8_s" 应理解为 16 维旋量 S₁₆，旋量维数 16（非 8）】
...
print(f"""
  ...
  前提 (i)   : 涌现 Clifford 代数 = Cl(1,7)（旋量表示 8_s 独立确定）【2026-08-07 勘误：旧遗留记号 "8_s" 应理解为 16 维旋量 S₁₆，旋量维数 16（非 8）】
