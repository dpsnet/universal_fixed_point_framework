...
**推论 3.1**（$k_{\max}=8$）。在谱动力学框架中，$A_{\text{GR}}$ 的 Casimir 谱截断 $k_{\max}$ 等于 $\mathrm{Cl}(1,7)$ 旋量空间的维数 $8$（见 `notes/11_transition_bridges/category_to_rep_bridge_53D.md` §1.4 的详细论证）。
