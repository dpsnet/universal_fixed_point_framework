...
> - **v1.2（2026-07-27）**：按"笔记先行"研究操作规范，本文档自 `docs/UFPF修复与推进方案/层次演化的结构分析.md` 迁移至 `notes/08_first_principles/spectral_hierarchy_evolution_analysis.md`；更新 `scripts/paperX_dH_moran_perturbation.py` 中的文档引用
