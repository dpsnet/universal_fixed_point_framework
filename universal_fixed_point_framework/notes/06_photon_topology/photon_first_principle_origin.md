...
**开放项**：自伴性严格证明的 **Lean 形式化**（Kato–Rellich/Nelson，谱理论库依赖——推导级 + 数值佐证已闭合 2026-08-14）；完整谱等式与 Mourre 估计实施（a.c. 谱确认，RAGE 全条件）；WW 复极点的 Lean 代数骨架；成熟后提炼 paper44 §2.4/§7.5。
