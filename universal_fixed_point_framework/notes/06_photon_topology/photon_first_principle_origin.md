...
**开放项**：自伴性、Mourre 估计与 Friedrichs 模型的 **Lean 形式化**（Kato–Rellich/Nelson + 谱测度/复分析库依赖——推导级 + 数值佐证已闭合 2026-08-14）；耦合情形 a.c. 谱保持的独立证明（FGSS 线文献引用）；WW 复极点的 Lean 代数骨架；成熟后提炼 paper44 §2.4/§7.5。
