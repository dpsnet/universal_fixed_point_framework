...
**状态**：🟢 研究笔记 v0.26（2026-08-11，方向整合 §7.24：时间耦合线数值验证（S11-S15，6/6，脚本 paperX_photon_time_coupling.py 注册）——γ→∞ 极限收敛（1/γ 单调递减至 <1e-6）/cosθ≡1/γ/boost 三角参数化等价/牛顿斜线vs相对论渐近/光速锁定复核——paper44 开放问题 #1 数值层闭合）
