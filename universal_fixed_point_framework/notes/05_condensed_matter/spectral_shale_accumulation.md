...
|:--|:--|:--|:--|:--|
| P1 | 谱隙-门限压力双曲标度 | $\log P_t = C/(D-2)+B$，$D\to2^+$ 时 $P_t$ 对数发散 | Washburn 方程只给 $P_t$–孔径关系；$P_t$–$D$ 在文献中仅经验线性/幂律拟合，无第一性函数形式 | M11 实证：双曲 R²=0.578 > 线性 0.450；理论斜率 2.24 ≈ 实测 1.81；证伪边界测试已实施（F1a 发散抑制检出、F1b H2 破缺检出、真实数据 C-D 秩相关 −0.141 未破缺，预测未被证伪）；$D\to2$ 端待极端均匀样品（低复杂度页岩/粉砂质）检验 |
