...
**D5 k_max=8 循环性**：paper36 自认 k_max=8 为**模型选择**（扫描 {4,6,8,16,100} 与 Paper IX ρ_c = 0.335 最佳匹配）；Δλ_min 公式在**给定 k_max 下**才严格（Lean 形式化证明公式，未证明 k_max=8 的选择）——**Δλ_min = 0.122 的"第一性"仅限"给定 k_max=8"**。
