...
**定理 1.1**（电荷量子化定理）。在谱框架中，$Q_{\text{EM}}$ 在 $8_s$ 旋量表示上的本征值谱限于以下离散集：【2026-08-07 勘误：旧遗留记号 "$8_s$" 应理解为 16 维旋量 S₁₆；Cl(1,7) 标准矩阵代数 = M₁₆(ℝ)，旋量维数 16（非 8）】
...
| $Q$ | 多重度 | $8_s$ 态【2026-08-07 勘误：旧遗留记号，即 16 维旋量 S₁₆】 | SM 场 |
|:--:|:-----:|:---------|:------|
