...
| 62G | P5 定义精确化 | 开放声称降级为可证命题（笔记 §3.5 + Lean + 数值） | 🔶 推进中（2026-08-12 启动：P5-1 精确化清查 → P5-2 4-范畴方向正交代数化 → P5-3 Φ=D|_Rec 严格等式 → P5-4 代数谱骨架 `PhotonTopologySpectral.lean` → P5-5 边界同步；层次 B 连续谱保持库依赖开放项不硬搭） |
